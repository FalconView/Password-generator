...
generateBtn.addEventListener("click", function () {
  ...
  var generatePassword = function () {
    ...
    if (!(length >= 8 && length <= 128)) {
      alert(
        "The answer is not valid. Please enter the number between 8 and 128."
      );
      return "";
    }
    ...
    if (excludeType === charType.length) {
      alert(
        "You did not select any characters. Please select at least 1 character."
      );
      return "";
    }
    ...
    var randomPassword = function () {
      ...
      if (pswCrit[1].lowCase === true) {
        // with lowCase
        if (pswCrit[1].upCase === true) {
          //with upCase
          if (pswCrit[1].numChar === true) {
            // with num
            if (pswCrit[1].specChar === true) {
              // with spec
              var characters =
                letters + letters.toUpperCase() + numbers + special;
              randomForm();
              console.log(result);
              return result;
            } else {
        ...
        if (pswCrit[1].upCase === true) {
          ...
          if (pswCrit[1].numChar === true) {
            ...
            // w/o lowCase, with upCase, w/o num
            if (pswCrit[1].specChar === true) {
              // with spec
          ...
          if (pswCrit[1].numChar === true) {
            ...
            // w/o lowCase and upCase and num, only spec
